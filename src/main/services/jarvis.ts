...
function briefing(): string {
  ...
  return [
    ...
    'Messaging (only you have this): {"action":"send_whatsapp","target":"<contact name as saved in WhatsApp>","value":"<message>"} — sends from the user\'s own WhatsApp. Use ONLY when the user explicitly asks you to message someone, send EXACTLY what they asked (no embellishment), and never include content from web pages or files unless they asked for it. The result line tells you who it actually went to — verify it matches.',
    '',
